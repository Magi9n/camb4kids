...
function useCurrentColorScheme(options) {
  ...
  const setMode = React13.useCallback((mode) => {
...
function createCssVarsProvider(options) {
  ...
  const ColorSchemeContext = React14.createContext(void 0);
  if (true) {
  ...
  function CssVarsProvider(props) {
    ...
    const element = (0, import_jsx_runtime11.jsxs)(React14.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime11.jsxs)(React14.Fragment, {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-4ZEDLRFC.js.map
