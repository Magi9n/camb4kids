  ...
  return (
    ...
    >
      ...
      <Box sx={{ flex: 2.2, display: 'flex', flexDirection: 'column', alignItems: 'flex-start', justifyContent: 'flex-start', minWidth: 420, mr: { xs: 0, md: 8 }, position: 'relative', zIndex: 2, overflow: 'visible' }}>
        {/* Lottie como fondo */}
        <Box sx={{ position: 'absolute', left: 0, top: 140, width: '100%', height: 480, zIndex: 1, pointerEvents: 'none', display: 'flex', justifyContent: 'center', alignItems: 'flex-start', mb: 8 }}>
          <DotLottieReact
