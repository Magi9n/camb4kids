    ...
    <Box sx={{ py: 6, textAlign: 'center', bgcolor: '#fff', fontFamily: 'Roboto, sans-serif' }}>
      ...
      <Grid container spacing={4} justifyContent="center">
        ...
        <Grid item xs={12} md={4}>
          <Paper elevation={0} sx={{ p: 2, textAlign: 'left', borderRadius: 6, minHeight: 160, bgcolor: '#f7f8fa', boxShadow: '0 2px 12px 0 rgba(0,0,0,0.04)', maxWidth: 260, mx: 'auto' }}>
            ...
            <Box sx={{ width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', mt: 1 }}>
              <Lottie animationData={dineroconalas} loop autoplay style={{ width: 64, height: 64 }} />
            </Box>
          </Paper>
        </Grid>
        {/* Cuadro 2: Preferencial */}
        <Grid item xs={12} md={4}>
          <Paper elevation={0} sx={{ p: 2, textAlign: 'left', borderRadius: 6, minHeight: 160, bgcolor: '#baffd7', boxShadow: '0 2px 12px 0 rgba(0,0,0,0.04)', maxWidth: 260, mx: 'auto' }}>
            <Typography sx={{ fontFamily: 'Roboto, sans-serif', fontWeight: 700, fontSize: 17, color: '#111', mb: 0.5 }}>
            ...
            <Box sx={{ width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', mt: 1 }}>
              <img src={astronautamillonario} alt="Astronauta millonario" style={{ width: 64, height: 64, objectFit: 'contain' }} />
            </Box>
          </Paper>
        </Grid>
        {/* Cuadro 3: Empresarial */}
        <Grid item xs={12} md={4}>
          <Paper elevation={0} sx={{ p: 2, textAlign: 'left', borderRadius: 6, minHeight: 160, bgcolor: '#d6ffe9', boxShadow: '0 2px 12px 0 rgba(0,0,0,0.04)', maxWidth: 260, mx: 'auto' }}>
            <Typography sx={{ fontFamily: 'Roboto, sans-serif', fontWeight: 700, fontSize: 17, color: '#111', mb: 0.5 }}>
            ...
            <Box sx={{ width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', mt: 1 }}>
              <Lottie animationData={empresario} loop autoplay style={{ width: 64, height: 64 }} />
            </Box>
          </Paper>
        </Grid>
      </Grid>
